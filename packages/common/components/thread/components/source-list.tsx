        ...
        <div className="flex min-h-full flex-col gap-6 py-3 pl-2 pr-4">
            {sortedSources.map(source => (
                <div className="flex w-full flex-row items-start gap-4" key={source.link}>
                    <div className="text-brand bg-brand/20 group mx-0.5 my-0.5 inline-flex size-4 shrink-0 flex-row items-center justify-center gap-1 rounded-sm text-xs font-medium">
                        {source?.index}
                    </div>
