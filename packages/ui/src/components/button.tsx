...
const buttonVariants = cva(
    'inline-flex items-center gap-2 justify-center font-medium whitespace-nowrap rounded-xl transition-colors focus-visible:outline-none [&>svg]:text-muted-foreground disabled:opacity-70',
    {
        variants: {
            ...
            size: {
                default: 'h-9 px-3 text-sm md:text-base',
                sm: 'h-8 px-3 text-sm md:text-sm rounded-xl',
                xs: 'h-7 px-2 text-sm md:text-sm',
                md: 'h-9 px-4 text-sm md:text-base font-semibold',
                lg: 'h-10 md:h-10  px-8 text-sm md:text-base font-semibold',
                icon: 'h-8 min-w-8 text-sm md:text-base',
                'icon-sm': 'h-7 min-w-7 text-sm md:text-base',
                'icon-xs': 'h-6 min-w-6 text-sm md:text-base',
                'link-sm': 'p-0 text-sm',
                link: 'p-0',
            },
            rounded: {
