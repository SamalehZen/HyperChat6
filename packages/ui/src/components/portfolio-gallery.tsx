...
const DEFAULT_IMAGES: Array<{ src: string; alt: string; title?: string }> = [
  ...
  },
  {
    ...
    alt: 'Design minimaliste en noir et blanc',
  ...
  {
    src: 'https://images.unsplash.com/photo-1500534313956-4c8d0eaf5854?q=80&w=1200&auto=format&fit=crop',
    alt: 'Portrait artistique en contre-jour',
...
export const PortfolioGallery: React.FC<PortfolioGalleryProps> = ({
  ...
  const tileHeight = Math.min(maxHeight, containerHeight);
  ...
  return (
    ...
    >
      ...
      {/* Desktop: rangée compacte avec overlap léger */}
      <div className="hidden h-full w-full items-center overflow-visible md:flex">
        <div
          className={cn(
            'flex items-center overflow-visible',
            spacing || '-space-x-24 xl:-space-x-32'
          )}
        >
          {images.map((img, idx) => (
            <motion.button
